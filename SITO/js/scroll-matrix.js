...
(function InitializeToroidalOverscan() {
    ...
    const basePool = [
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/DICIOTTO.PNG' },
        { type: 'video', src: 'https://res.cloudinary.com/db30mvs3d/video/upload/VIDEO/ALLSYSTEMCOMPRESSI/VIDEOSETTE.mp4' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/TRENTOTTO.PNG' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/UNO.png' },
        { type: 'video', src: 'https://res.cloudinary.com/db30mvs3d/video/upload/VIDEO/ALLSYSTEMCOMPRESSI/VIDEOQUINDICI.mp4' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/QUARANTUNO.PNG' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/CINQUANTA.PNG' },
        { type: 'video', src: 'https://res.cloudinary.com/db30mvs3d/video/upload/VIDEO/ALLSYSTEMCOMPRESSI/VIDEODUE.mp4' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/QUARANTA.PNG' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/TRENTUNO.png' },
        { type: 'video', src: 'https://res.cloudinary.com/db30mvs3d/video/upload/VIDEO/ALLSYSTEMCOMPRESSI/VIDEONOVE.mp4' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/VENTISETTE.PNG' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/VENTUNO.png' },
        { type: 'video', src: 'https://res.cloudinary.com/db30mvs3d/video/upload/VIDEO/ALLSYSTEMCOMPRESSI/VIDEOVENTIDUE.mp4' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/SEI.PNG' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/QUARANTAQUATTRO.PNG' },
        { type: 'video', src: 'https://res.cloudinary.com/db30mvs3d/video/upload/VIDEO/ALLSYSTEMCOMPRESSI/VIDEOOTTO.mp4' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/TRE.PNG' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/DODICI.PNG' },
        { type: 'video', src: 'https://res.cloudinary.com/db30mvs3d/video/upload/VIDEO/ALLSYSTEMCOMPRESSI/VIDEOTRE.mp4' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/TRENTADUE.png' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/QUARANTANOVE.PNG' },
        { type: 'video', src: 'https://res.cloudinary.com/db30mvs3d/video/upload/VIDEO/ALLSYSTEMCOMPRESSI/VIDEOUNDICI.mp4' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/TRENTAQUATTRO.png' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/DICIANNOVE.PNG' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/VENTIDUE.PNG' },
        { type: 'video', src: 'https://res.cloudinary.com/db30mvs3d/video/upload/VIDEO/ALLSYSTEMCOMPRESSI/VIDEOSEDICI.mp4' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/OTTO.JPG' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/CINQUE.PNG' },
        { type: 'video', src: 'https://res.cloudinary.com/db30mvs3d/video/upload/VIDEO/ALLSYSTEMCOMPRESSI/VIDEOVENTI.mp4' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/VENTITRE.PNG' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/DIECI.PNG' },
        { type: 'video', src: 'https://res.cloudinary.com/db30mvs3d/video/upload/VIDEO/ALLSYSTEMCOMPRESSI/VIDEOUNO.mp4' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/QUATTORDICI.png' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/VENTISEI.PNG' },
        { type: 'video', src: 'https://res.cloudinary.com/db30mvs3d/video/upload/VIDEO/ALLSYSTEMCOMPRESSI/VIDEODICIASETTE.mp4' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/CINQUANTUNO.PNG' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/TRENTANOVE.PNG' },
        { type: 'video', src: 'https://res.cloudinary.com/db30mvs3d/video/upload/VIDEO/ALLSYSTEMCOMPRESSI/VIDEOCINQUE.mp4' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/SETTE.PNG' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/QUARANTASEI.PNG' },
        { type: 'video', src: 'https://res.cloudinary.com/db30mvs3d/video/upload/VIDEO/ALLSYSTEMCOMPRESSI/VIDEODODICI.mp4' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/TREDICI.PNG' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/QUARANTATRE.PNG' },
        { type: 'video', src: 'https://res.cloudinary.com/db30mvs3d/video/upload/VIDEO/ALLSYSTEMCOMPRESSI/VIDEODICIOTTO.mp4' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/VENTINOVE.png' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/TRENTATRE.png' },
        { type: 'video', src: 'https://res.cloudinary.com/db30mvs3d/video/upload/VIDEO/ALLSYSTEMCOMPRESSI/VIDEODIECI.mp4' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/QUARANTASETTE.PNG' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/TRENTA.png' },
        { type: 'video', src: 'https://res.cloudinary.com/db30mvs3d/video/upload/VIDEO/ALLSYSTEMCOMPRESSI/VIDEOSEI.mp4' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/SEDICI.jpg' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/QUATTRO.JPG' },
        { type: 'video', src: 'https://res.cloudinary.com/db30mvs3d/video/upload/VIDEO/ALLSYSTEMCOMPRESSI/VIDEOTREDICI.mp4' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/VENTOTTO.PNG' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/UNDICI.PNG' },
        { type: 'video', src: 'https://res.cloudinary.com/db30mvs3d/video/upload/VIDEO/ALLSYSTEMCOMPRESSI/VIDEOVENTUNO.mp4' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/TRENTASEI.png' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/VENTICINQUE.PNG' },
        { type: 'video', src: 'https://res.cloudinary.com/db30mvs3d/video/upload/VIDEO/ALLSYSTEMCOMPRESSI/VIDEODICIANNOVE.mp4' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/QUARANTOTTO.PNG' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/TRENTASETTE.png' },
        { type: 'video', src: 'https://res.cloudinary.com/db30mvs3d/video/upload/VIDEO/ALLSYSTEMCOMPRESSI/VIDEOQUATTRO.mp4' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/VENTI.png' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/CINQUANTADUE.PNG' },
        { type: 'video', src: 'https://res.cloudinary.com/db30mvs3d/video/upload/VIDEO/ALLSYSTEMCOMPRESSI/VIDEOQUATTORDICI.mp4' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/QUARANTADUE.PNG' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/VENTIQUATTRO.PNG' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/NOVE.PNG' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/TRENTACINQUE.png' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/QUARANTACINQUE.PNG' },
        { type: 'image', src: 'https://res.cloudinary.com/db30mvs3d/image/upload/IMMAGINI/ALLSYSTEMS/DICIASETTE.PNG' }
    ];
